...
\vspace{0.3em}
{\footnotesize Methods: activation patching, attribution patching, EAP (Syed et al., 2024).}
...
\begin{tikzpicture}[scale=0.7]
  ...
  \node[font=\tiny,neutral] at (2,4.0) {Q1: \emph{this edge matters}};
  ...
  \node[font=\tiny,grass] at (2,1.5) {$f_i$};
  \node[font=\tiny,neutral,align=center] at (2,0.5) {Q2: \emph{factor $f_i$ carries}\\[-0.1em]\emph{the signal}};
\end{tikzpicture}
...
\vspace{0.3em}
{\footnotesize Adapted from Tower, Vegner, Siddharth \& Doumas (in preparation).}
\end{frame}
...
Comp.\ add.\ (s42) & $\times$ & 3.412 & 0.860 & ${>}32$ & 0.110 & \textcolor{stoch}{Stochastic} \\
\midrule
...
\begin{tikzpicture}[scale=0.75]
  ...
  \node[font=\scriptsize,align=center] at (1,3.3) {2 operations (4 seeds)};
